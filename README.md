...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21402822.svg)](https://doi.org/10.5281/zenodo.21402822)
...
```bash
pytest tests/ -v   # 99 tests, all verify physics not arithmetic
```
